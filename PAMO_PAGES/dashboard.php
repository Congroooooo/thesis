            ...
            <div class="dashboard">
                ...
                <div class="analytics-section">
                    <div class="analytics-card sales-analytics">
                        <div class="sales-filters" style="position: absolute; top: 20px; left: 24px; z-index: 2; width: auto; background: none; box-shadow: none; padding: 0; margin-bottom: 0;">
                            <label>
                                Category:
                        ...
                        <div class="section-title" style="margin-top: 52px;">Sales Analytics</div>
